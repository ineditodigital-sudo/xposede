...
import { X, Send, MessageCircle, ChevronLeft, CheckCircle2, Building2, User, Briefcase, Clock, Phone, Mail, Sparkles, TrendingUp, Zap, Gift, Award, Target, Palette, Hammer, Calendar, DollarSign, Monitor } from 'lucide-react';
...
export function ChatAssistant({ isOpen, onClose }: ChatAssistantProps) {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { type: 'bot', text: '¡Hola! 👋 Soy tu asistente virtual de Xpo Sedde. Estoy aquí para ayudarte a crear el stand perfecto para tu próximo evento.' }
  ]);
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      setMessages(prev => [...prev, 
        { type: 'bot', text: 'Excelente pregunta 💡 Basado en tu perfil, un Xpo Asesor especializado revisará tu caso específico. Te contactaremos con una propuesta personalizada.' }
      ]);
    }, 1500);
  };
  ...
  const isContactFormValid = contactName.trim().length >= 2 && isValidEmail(contactEmail) && isValidPhone(contactPhone) && contactCompany.trim().length >= 2 && contactPosition.trim().length >= 2;
  ...
  const sendToWhatsApp = () => {
    ...
    const needsText = needs === 'stand-diseño' ? '🎨 Stand de Diseño Personalizado'
      ...
      : needs === 'displays-pop' ? '📱 Displays Pop'
    ...
    if (experience === 'experimentado') {
      // Mensaje especial para clientes experimentados que quieren agendar videollamada
      message = `📞 *SOLICITUD DE VIDEOLLAMADA - COTIZADOR INTELIGENTE*
...
🎯 *SOLICITUD:*
✅ Cliente experimentado solicita videollamada con Xpo Asesor
✅ Interesado en usar el Cotizador Inteligente

🎁 *BENEFICIOS PROMETIDOS:*
✅ Consulta con experto sin costo
✅ Obtén un beneficio por contactar ahora

_Mensaje generado desde el Asistente Virtual - ${new Date().toLocaleString('es-MX')}_`;
    } else {
      // Mensaje estándar para otros clientes
      message = `🎯 *NUEVA SOLICITUD - ASISTENTE VIRTUAL XPO SEDDE*
        ...
        return (
          ...
          >
            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
              ...
              >
                <h3 className="text-gray-900 mb-3">Asistente Virtual Xpo Sedde</h3>
                  ...
                  <div className="space-y-3 text-sm text-gray-700">
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-8 h-8 rounded-lg bg-xposedde-red/10 flex items-center justify-center flex-shrink-0">
                        <Gift className="w-4 h-4 text-xposedde-red" />
                      </div>
                      <div>
                        <div className="font-medium text-gray-900">Beneficio exclusivo</div>
                        <div className="text-xs text-gray-500">Por contactar ahora</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-8 h-8 rounded-lg bg-xposedde-gray/10 flex items-center justify-center flex-shrink-0">
                        <Award className="w-4 h-4 text-xposedde-gray" />
                      </div>
                      <div>
                        <div className="font-medium text-gray-900">Consulta sin costo</div>
                        <div className="text-xs text-gray-500">Con nuestros expertos</div>
                      </div>
                    </div>
                  </div>
                </Card>
      ...
      case 'client-type':
        return (
          ...
          >
            ...
            <div className="flex-shrink-0 p-3 sm:p-4 border-t bg-white shadow-lg">
              <Button 
                className="w-full bg-xposedde-red hover:bg-xposedde-red-hover shadow-md text-sm sm:text-base"
                disabled={!clientType}
          ...
          >
            ...
            <div className="flex-shrink-0 p-3 sm:p-4 border-t bg-white shadow-lg">
              <Button 
                ...
                size="lg"
              >
                {experience === 'experimentado' ? 'Continuar' : 'Continuar'}
                <TrendingUp className="ml-2 w-4 h-4" />
              </Button>
            </div>
          </motion.div>
          ...
          >
            <div className="flex-1 min-h-0 p-4 sm:p-6 overflow-y-auto overscroll-contain">
              ...
              >
                ...
                >
                  <Button
                    className="w-full bg-xposedde-red hover:bg-xposedde-red-hover shadow-lg text-base sm:text-lg h-14 sm:h-16"
                    onClick={() => {
      ...
      case 'needs':
        return (
          ...
          >
            ...
            <div className="flex-shrink-0 p-3 sm:p-4 border-t bg-white shadow-lg z-10">
              <Button 
                className="w-full bg-xposedde-red hover:bg-xposedde-red-hover shadow-md text-sm sm:text-base"
                disabled={!needs}
      ...
      case 'timeline':
        return (
          ...
          >
            ...
            <div className="flex-shrink-0 p-3 sm:p-4 border-t bg-gradient-to-r from-gray-50 to-white shadow-lg">
              <Button 
                className="w-full bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 shadow-md text-sm sm:text-base"
                disabled={!timeline}
      ...
      case 'contact':
        return (
          <motion.div 
            ...
            key="contact"
          >
            <div className="flex-1 min-h-0 overflow-y-auto bg-gradient-to-b from-orange-50/30 to-white">
              <div className="p-4 sm:p-6">
                ...
                >
                  <Card className="bg-gradient-to-br from-red-50 to-orange-50 border-red-200 shadow-sm p-4 mb-6">
                    ...
                    <div className="text-sm text-gray-700 space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        <CheckCircle2 className="w-4 h-4 text-red-600" />
                        <span><strong>Obtén un beneficio</strong> por contactar ahora</span>
                      </div>
                    </div>
                  </Card>
                </motion.div>
                ...
                <div className="space-y-4">
                  ...
                  >
                    <Label htmlFor="contact-company" className="text-gray-700 mb-1.5 block text-sm flex items-center gap-2">
                  ...
                  <motion.div
                    ...
                    transition={{ delay: 0.5 }}
                  >
                    <Label htmlFor="contact-position" className="text-gray-700 mb-1.5 block text-sm flex items-center gap-2">
            ...
            <div className="flex-shrink-0 p-3 sm:p-4 border-t bg-gradient-to-r from-gray-50 to-white shadow-lg">
              <Button 
                className="w-full bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 shadow-lg text-sm sm:text-base"
              ...
              >
                <div className="p-4 text-white">
                  ...
                  <div className="text-sm text-green-100">
                    Contacta directamente con un Xpo Asesor por WhatsApp
                  </div>
                </div>
              </Card>
            </div>
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div 
            className="bg-white rounded-t-2xl sm:rounded-2xl shadow-2xl w-full max-w-md h-[100dvh] sm:h-[90vh] flex flex-col overflow-hidden"
          ...
          >
            ...
            {/* Header */}
            <div className="flex items-center justify-between p-3 sm:p-4 border-b bg-gradient-to-r from-white to-gray-50 flex-shrink-0">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <h2 className="text-gray-900 text-sm font-medium">Asistente Xpo Sedde</h2>
                    <motion.div
                      animate={{ scale: [1, 1.2, 1] }}
                      transition={{ duration: 2, repeat: Infinity }}
